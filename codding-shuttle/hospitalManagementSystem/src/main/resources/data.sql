...
VALUES
    ('Dr. Anjali Mehta', 'Cardiologist', 'anjali.mehta@example.com'),
    ('Dr. Rohan Kapoor', 'Dermatologist', 'rohan.kapoor@example.com'),
    ('Dr. Priya Singh', 'Pediatrician', 'priya.singh@example.com');